...
function show_menu(){
	...
	top = Math.floor(h / 3);
	const bs = ["Начать играть", "Управление", "Скорость"];
	let m;
...
function show_help(){
	...
	const hs = "Управление игрой при помощи правой панели";
